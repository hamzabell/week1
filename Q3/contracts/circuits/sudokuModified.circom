...
template  sudoku() {
    ...
    // check whether the solution is zero everywhere the puzzle h as values (to avoid trick solution)
    ...
    for (var i=0;i<9; i++) {
        for (var j=0; j< 9;j++) {
            ...
            // initialize rangeProof component for each input of the matrix
